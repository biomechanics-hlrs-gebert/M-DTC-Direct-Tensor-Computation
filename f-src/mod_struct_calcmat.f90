...
! CALL raise_branch(trim(desc), 0_pd_ik, 0_pd_ik, result_branch)
...
CALL MPI_FILE_WRITE_AT(fh_mpi_worker(4), &
    Int(root%branches(3)%leaves(1)%lbound-1+(lin_nn-1), MPI_OFFSET_KIND), &
    ddc_nn, &
    Int(ddc_nn, pd_mik), MPI_INTEGER8, &
    status_mpi, ierr)
...
CALL MPI_FILE_WRITE_AT(fh_mpi_worker(5), &
    Int(root%branches(3)%leaves(2)%lbound-1+(lin_nn-1)*no_lc*no_lc, MPI_OFFSET_KIND), &
...
CALL MPI_FILE_WRITE_AT(fh_mpi_worker(5), &
    Int(root%branches(3)%leaves(3)%lbound-1+(lin_nn-1)*no_lc*no_lc, MPI_OFFSET_KIND), &
    reshape(stiffness,[no_lc*no_lc]), &
    Int(no_lc*no_lc,pd_mik), MPI_Real8, &
    status_mpi, ierr)
...
CALL MPI_FILE_WRITE_AT(fh_mpi_worker(5), &
    Int(root%branches(3)%leaves(4)%lbound-1+(lin_nn-1), MPI_OFFSET_KIND), &
    tmp_real_fd1, &
...
CALL MPI_FILE_WRITE_AT(fh_mpi_worker(5), &
    Int(root%branches(3)%leaves(5)%lbound-1+(lin_nn-1)*6*no_lc, MPI_OFFSET_KIND), &
...
CALL MPI_FILE_WRITE_AT(fh_mpi_worker(5), &
    Int(root%branches(3)%leaves(6)%lbound-1+(lin_nn-1)*6*no_lc, MPI_OFFSET_KIND), &
...
CALL MPI_FILE_WRITE_AT(fh_mpi_worker(5), &
    Int(root%branches(3)%leaves(7)%lbound-1+(lin_nn-1)*36, MPI_OFFSET_KIND), &
    reshape(cc_mean,[36]), &
...
CALL MPI_FILE_WRITE_AT(fh_mpi_worker(5), &
    Int(root%branches(3)%leaves(8)%lbound-1+(lin_nn-1), MPI_OFFSET_KIND), &
    tmp_real_fd1, &
    Int(1,pd_mik), MPI_Real8, &
    status_mpi, ierr)
...
CALL MPI_FILE_WRITE_AT(fh_mpi_worker(5), &
    Int(root%branches(3)%leaves(9)%lbound-1+(lin_nn-1)*36, MPI_OFFSET_KIND), &
    reshape(ee,[36]), &
    Int(36,pd_mik), MPI_Real8, &
    status_mpi, ierr)
...
CALL MPI_FILE_WRITE_AT(fh_mpi_worker(5), &
    Int(root%branches(3)%leaves(10)%lbound-1+(lin_nn-1), MPI_OFFSET_KIND), &
    tmp_real_fd1, &
    Int(1,pd_mik), MPI_Real8, &
    status_mpi, ierr)
...
!!$                     sum((tmp_r6x6(1:4,5:6))*(tmp_r6x6(1:4,5:6))))
    ...
    CALL MPI_FILE_WRITE_AT(fh_mpi_worker(5), &
         Int(root%branches(3)%leaves(11)%lbound-1+(lin_nn-1), MPI_OFFSET_KIND), &
         tmp_real_fd1, &
         Int(1,pd_mik), MPI_Real8, &
         status_mpi, ierr)
    ...
    CALL MPI_FILE_WRITE_AT(fh_mpi_worker(5), &
         Int(root%branches(3)%leaves(12)%lbound-1+(lin_nn-1)*3, MPI_OFFSET_KIND), &
         n, &
    ...
    CALL MPI_FILE_WRITE_AT(fh_mpi_worker(5), &
         Int(root%branches(3)%leaves(13)%lbound-1+(lin_nn-1)*9, MPI_OFFSET_KIND), &
         reshape(aa,[9_pd_ik]), &
    ...
    CALL MPI_FILE_WRITE_AT(fh_mpi_worker(5), &
        Int(root%branches(3)%leaves(14)%lbound-1+(lin_nn-1)*36, MPI_OFFSET_KIND), &
        reshape(EE,[36_pd_ik]), &
        Int(36,pd_mik), MPI_Real8, &
        status_mpi, ierr)
    ...
    CALL MPI_FILE_WRITE_AT(fh_mpi_worker(5), &
        Int(root%branches(3)%leaves(15)%lbound-1+(lin_nn-1), MPI_OFFSET_KIND), &
        tmp_real_fd1, &
        Int(1,pd_mik), MPI_Real8, &
        status_mpi, ierr)
    ...
    CALL MPI_FILE_WRITE_AT(fh_mpi_worker(5), &
        Int(root%branches(3)%leaves(16)%lbound-1+(lin_nn-1)*3, MPI_OFFSET_KIND), &
        n, &
        Int(3,pd_mik), MPI_Real8, &
        status_mpi, ierr)
    ...
    CALL MPI_FILE_WRITE_AT(fh_mpi_worker(5), &
        Int(root%branches(3)%leaves(17)%lbound-1+(lin_nn-1)*9, MPI_OFFSET_KIND), &
        reshape(aa,[9_pd_ik]), &
        Int(9,pd_mik), MPI_Real8, &
        status_mpi, ierr)
    ...
    CALL MPI_FILE_WRITE_AT(fh_mpi_worker(5), &
        Int(root%branches(3)%leaves(18)%lbound-1+(lin_nn-1)*36, MPI_OFFSET_KIND), &
        reshape(EE,[36_pd_ik]), &
        Int(36,pd_mik), MPI_Real8, &
        status_mpi, ierr)
    ...
    eff_density = ( ANINT(x_D_phy(1)/delta(1)) * &
                    ...
                    ANINT(x_D_phy(3)/delta(3)) ) / REAL(no_dat, KIND=rk)

    CALL add_leaf_to_branch(result_branch, "Effective density", 1_pd_ik, [eff_density])
    CALL MPI_FILE_WRITE_AT(fh_mpi_worker(5), &
        Int(root%branches(3)%leaves(19)%lbound-1+(lin_nn-1), MPI_OFFSET_KIND), &
        eff_density, &
        Int(1,pd_mik), MPI_Real8, &
        status_mpi, ierr)
